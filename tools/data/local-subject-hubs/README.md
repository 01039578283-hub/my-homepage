...
- Twelve Vercel redirect rules cover the six school-stage/subject patterns and their `index.html` forms. Old and new Korean/encoded URLs must be tested on a deployment.
